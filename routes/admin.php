...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function (): void {
    ...
    Route::get('results', [\App\Http\Controllers\Admin\ResultManagementController::class, 'index'])->name('results.index');
    Route::post('results', [\App\Http\Controllers\Admin\ResultManagementController::class, 'store'])->name('results.store');
    Route::get('results/{period}', [\App\Http\Controllers\Admin\ResultManagementController::class, 'show'])->name('results.show');
    Route::post('results/{period}/marks', [\App\Http\Controllers\Admin\ResultManagementController::class, 'mark'])->name('results.mark');
    Route::post('results/{period}/import', [\App\Http\Controllers\Admin\ResultManagementController::class, 'import'])->name('results.import');
    Route::post('results/{period}/import-sheet', [\App\Http\Controllers\Admin\ResultManagementController::class, 'importSheet'])->name('results.import-sheet');
    Route::patch('results/{period}/status', [\App\Http\Controllers\Admin\ResultManagementController::class, 'status'])->name('results.status');
    ...
    Route::get('account-settings', [\App\Http\Controllers\Admin\AccountNumberingController::class, 'index'])->name('accounts.index');
    Route::post('account-settings/preview', [\App\Http\Controllers\Admin\AccountNumberingController::class, 'preview'])->name('accounts.preview');
    Route::put('account-settings', [\App\Http\Controllers\Admin\AccountNumberingController::class, 'update'])->name('accounts.update');
    Route::get('students/{student}/account-card', [\App\Http\Controllers\Admin\AccountNumberingController::class, 'card'])->name('students.account-card');
    ...
    Route::put('settings/account-password', [\App\Http\Controllers\Admin\AccountPasswordController::class, 'update'])->name('settings.account-password.update');
