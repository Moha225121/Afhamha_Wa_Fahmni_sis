@extends('teacher.layout') @section('title',$student->user->name) @section('subtitle','ملف الطالب الأكاديمي') @section('content')<p><a class="btn secondary" href="{{ route('teacher.students.analysis', $student) }}">تحليل مستوى الطالب وخطة الدعم بالذكاء الاصطناعي</a></p>
