...
class LocalDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $subject = Subject::firstOrCreate(
            ['code' => 'MATH-101'],
            ['name' => 'الرياضيات', 'stage' => 'أساسي', 'status' => 'active'],
        );
        ...
        $teacherUser = User::updateOrCreate(
            ...
            ['name' => 'أ. خالد العرفي', 'password' => 'password123', 'role' => 'teacher', 'status' => 'active', 'phone' => '0922222222'],
        );

        $teacher = Teacher::updateOrCreate(
            ['user_id' => $teacherUser->id],
            ['specialization' => 'الرياضيات', 'status' => 'active'],
        );
